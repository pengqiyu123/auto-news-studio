...
_LAZY_EXPORTS: dict[str, tuple[str, str]] = {
    ...
    "_build_ai_cover_prompt": (".wechat", "_build_ai_cover_prompt"),
    "_click_wechat_publish_until_qrcode": (".wechat", "_click_wechat_publish_until_qrcode"),
    "_ensure_wechat_ai_cover": (".wechat", "_ensure_wechat_ai_cover"),
    "_ensure_wechat_author_before_publish_settings": (".wechat", "_ensure_wechat_author_before_publish_settings"),
    "_select_collection_ai_news": (".wechat", "_select_collection_ai_news"),
    "_select_hidden_wechat_option_by_text": (".wechat", "_select_hidden_wechat_option_by_text"),
    ...
    "_run_publish_to_qrcode": (".wechat", "_run_publish_to_qrcode"),
    ...
    "open_wechat_remote_draft_by_title": (".wechat_debug", "open_wechat_remote_draft_by_title"),
    ...
    "test_wechat_cover_only": (".wechat_debug", "test_wechat_cover_only"),
    "inspect_wechat_publish_settings_dom": (".wechat_debug", "inspect_wechat_publish_settings_dom"),
    "test_collection_click": (".wechat_debug", "test_collection_click"),
    "test_claim_source_click": (".wechat_debug", "test_claim_source_click"),
    "eval_wechat_editor_js": (".wechat_debug", "eval_wechat_editor_js"),
